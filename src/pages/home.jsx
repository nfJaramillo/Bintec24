    ...
    return (
        <Grid container direction={{xs: 'column-reverse', md: 'row' }} alignItems={'center'} justifyContent={'center'} maxWidth="xl" sx={{  bgcolor: '#cfe8fc', minHeight: '80vh', borderRadius: 1, mt: 3, background: 'linear-gradient(to bottom, #F8F8F8, #FFFFFF)' }}>
            <Grid item xs={6} >
                ...
                <Typography textAlign={{xs: 'center', md: 'left' }} variant="h5" sx={{ mt: {xs: 3, md: 3 }, ml: {xs: 0, md: 3  } }}>Crea tu billetera digital, participa en el Market For 'Lemons' y recibe un NFT por tu participación.</Typography>
            </Grid>
