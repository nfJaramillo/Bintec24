...
`;var Y=globalThis&&globalThis.__decorate||function(n,e,t,a){var i=arguments.length,s=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,t):a,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,a);else for(var c=n.length-1;c>=0;c--)(o=n[c])&&(s=(i<3?o(s):i>3?o(e,t,s):o(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s};let S=class extends N{constructor(){var e,t;super(...arguments),this.dappImageUrl=(e=C.state.metadata)==null?void 0:e.icons,this.walletImageUrl=(t=g.state.connectedWalletInfo)==null?void 0:t.icon}firstUpdated(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelectorAll("wui-visual-thumbnail");e!=null&&e[0]&&this.createAnimation(e[0],"translate(18px)"),e!=null&&e[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){var e;return O`
    ...
    `}async onSign(){var e,t,a;this.isSigning=!0,h.sendEvent({event:"CLICK_SIGN_SIWE_MESSAGE",type:"track",properties:{network:((e=l.state.activeCaipNetwork)==null?void 0:e.id)||"",isSmartAccount:g.state.preferredAccountType===w.ACCOUNT_TYPES.SMART_ACCOUNT}});try{u.setStatus("loading");const i=await u.signIn();return u.setStatus("success"),h.sendEvent({event:"SIWE_AUTH_SUCCESS",type:"track",properties:{network:((t=l.state.activeCaipNetwork)==null?void 0:t.id)||"",isSmartAccount:g.state.preferredAccountType===w.ACCOUNT_TYPES.SMART_ACCOUNT}}),i}catch{const o=g.state.preferredAccountType===w.ACCOUNT_TYPES.SMART_ACCOUNT;return o?I.showError("This application might not support Smart Accounts"):I.showError("Signature declined"),u.setStatus("error"),h.sendEvent({event:"SIWE_AUTH_ERROR",type:"track",properties:{network:((a=l.state.activeCaipNetwork)==null?void 0:a.id)||"",isSmartAccount:o}})}finally{this.isSigning=!1}}async onCancel(){var t;this.isCancelling=!0,l.state.activeCaipAddress?(await v.disconnect(),b.close()):A.push("Connect"),this.isCancelling=!1,h.sendEvent({event:"CLICK_CANCEL_SIWE",type:"track",properties:{network:((t=l.state.activeCaipNetwork)==null?void 0:t.id)||"",isSmartAccount:g.state.preferredAccountType===w.ACCOUNT_TYPES.SMART_ACCOUNT}})}};m([x()],p.prototype,"isSigning",void 0);m([x()],p.prototype,"isCancelling",void 0);p=m([T("w3m-connecting-siwe-view")],p);function te(n){return new F(n)}export{u as SIWEController,S as W3mConnectingSiwe,p as W3mConnectingSiweView,te as createSIWEConfig,ie as formatMessage,J as getAddressFromMessage,X as getChainIdFromMessage,ae as getDidAddress,re as getDidChainId,Q as verifySignature};
